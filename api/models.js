...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (method === 'POST') {
      ...
      const query = `INSERT INTO modelos_terminal (nome, descricao) VALUES ($1, $2) RETURNING *;`;
    ...
    if (method === 'DELETE') {
      ...
      await pool.query('DELETE FROM modelos_terminal WHERE id = $1', [id]);
      return res.status(200).json({ message: 'Modelo deletado' });
    }
